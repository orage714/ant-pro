        ...
        // 商户准入信息 ---
        {
            "children": [
                // 附件信息
                {
                    ...
                    "value": {
                        "content": [
                            { "annexName": "url / xxx.jpg", "annexCategory": "other", "annexAddTime": 232414133132243, "annexLastModifyTime": 341344355322222222 },
                            { "annexName": "url / xxx.jpg", "annexCategory": "other", "annexAddTime": 232414133132243, "annexLastModifyTime": 341344355322222222 },
                            { "annexName": "url / xxx.jpg", "annexCategory": "other", "annexAddTime": 232414133132243, "annexLastModifyTime": 341344355322222222 },
                        ],
                        "extDatas": {
                ...
                // icp 备案
                {
                    ...
                    "value": {
                        "content": [
                            { "address": "www.baidu.com", "name": "蚂蚁金服", "beianhao": 2332243, "interName": "蚂蚁金服" },
                            { "address": "www.baidu.com", "name": "蚂蚁金服", "beianhao": 2332243, "interName": "蚂蚁金服" },
                            { "address": "www.baidu.com", "name": "蚂蚁金服", "beianhao": 2332243, "interName": "蚂蚁金服" },
                        ],
                        "extDatas": {
                    ...
                    "children": [
                        {
                            ...
                            "value": {
                                ...
                                "extParam": {
                                    "annexCategory": {
                                        "enums": [
                                            { "value": { "a": "有限公司", "b": '金融机构' }, "desc": "企业（机构）类型" },
                                        ]
                                    }
                                }
                            }
        ...
        // 风险交易信息    
        {
            "children": [
                // 风险稽查信息
                {
                    ...
                    "value": {
                        "content": [
                            { "type": "a", "jueCeName": "商户赌博-交易拦截-生成任务", "ceLuoName": "商户赌博-交易拦截-生成任务", "jichaTime": 341344355322222222, "description": "规则备注", "dingxin": "结案定性" },
                        ],
                        "extDatas": {
                            "schema": [
                    ...
                    "children": [
                        {
                            ...
                            "value": {
                                "content": [
                                    { "status": "a", "money": "-交易金额", "ceLuoName": "商户赌博-交易拦截-生成任务", "jichaTime": 341344355322222222, "description": "规则备注", "dingxin": "结案定性", "jiaoyiType": "a" },
                                ],
                                "extDatas": {
                                    "schema": [
                    ...
                    "children": [
                                ...
                                "content": [
                                    {
                                        ...
                                        "contactPhone": "137xxxxxxxx",
                                        "taskExtInfo": "",
                                        "answers": { "isMerchantExist": false, "merchantExistPicture": ["url / xxx.jpg", "url / xxx1.jpg"] }
                                    }
                                ],
                                "extDatas": {
                                    "schema": [
                                        { "name": "taskDrawTime", "desc": "任务领取时间", "dataType": "date", "showType": "basic" },
                                        { "name": "taskCompleteTime", "desc": "任务完成时间", "dataType": "date", "showType": "basic" },
                                        { "name": "businessHours", "desc": "营业时间", "dataType": "date", "showType": "basic" },
                                        { "name": "storeAddress", "desc": "店铺地址", "dataType": "string", "showType": "basic" },
                                        { "name": "contactPhone", "desc": "联系方式", "dataType": "string", "showType": "basic" },
                                        { "name": "taskExtInfo", "desc": "任务扩展信息", "dataType": "jsonObject", "showType": "basic" },
                                        {
                                            "name": "answers", "desc": "答题结果", "dataType": "jsonObject", "showType": "noEditable",
                                            "children": [
                                                { "name": "isMerchantExist", "desc": "商家是否存在", "dataType": "boolean", "showType": "block" },
                                                { "name": "merchantExistPicture", "desc": "商家是否存在的图片举证", "dataType": "jsonArr", "showType": "block" }
                                            ]
                                        }
                                    ]
                                },
                        ...
                        // 问卷巡检记录————————————————————————————————————————————
                        {
                            ...
                            "value": {
                                ...
                                "extDatas": {
                                    "schema": [
                                        { "name": "taskDrawTime", "desc": "问卷开始时间", "showType": "basic", "dataType": "datetime" },
                                        { "name": "taskCompleteTime", "desc": "问卷完成时间", "showType": "basic", "dataType": "datetime" },
                                        {
                                            "name": "answers", "desc": "问卷问题", "dataType": "jsonObject", "showType": "noEditable",
                                            "children": [
                                                { "name": "isMerchantExist", "desc": "商家是否存在", "dataType": "boolean", "showType": "block" },
                                                { "name": "merchantExistPicture", "desc": "商家是否存在的图片举证", "dataType": "jsonArr", "showType": "block" }
                                            ]
